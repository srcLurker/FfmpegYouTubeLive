#!/bin/bash
#
# Script to startup the youtube live camera feed from
# a fixed camera (such as the garden cam).
#
...
# This is a run once. The docker start script does the looping
# so if something dies, we can update this script and
# the next loop will pick it up.
